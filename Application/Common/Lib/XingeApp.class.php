...
class XingeApp
{
    ...
    {
        $this->_config = C('XGPUSH_CONFIG');
        $device_str = $device_type==2?'IOS_CONFIG':'ANDROID_CONFIG';
        $this->accessId = $this->_config[$device_str]['ACCESS_ID'];
        $this->secretKey = $this->_config[$device_str]['SECRET_KEY'];
    ...
    function PushSingleDeviceNotification($device_type,$title,$content,$custom,$token)
    {
//        $push = new XingeApp($device_type);
...
//        $custom = array('key1'=>'value1', 'key2'=>'value2');
     ...
     * @return array|mixed
     */
    function PushSingleDeviceIOS($device_type,$title,$custom,$token)
    {
//        $push = new XingeApp($device_type);
        $mess = new MessageIOS();
//        $push->device_type = $device_type;
...
//        $custom = array('key1'=>'value1', 'key2'=>'value2');
        ...
        $ret = $this->PushSingleDevice($token, $mess, XingeApp::IOSENV_DEV);
