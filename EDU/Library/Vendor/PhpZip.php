...
//        header('Content-Disposition: attachment ; filename=' . Str_Replace(".rar", "", basename($zipfilename)) . '.rar');
        header('Content-Disposition: attachment ; filename=' . Str_Replace(".rar", "", $zipfilename) . '.rar');
