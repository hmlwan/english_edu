...
-- Records of cx_admin
-- ----------------------------
INSERT INTO `cx_admin` VALUES ('1', '1', '127.0.0.1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1', '', '1575639633', '246', '1', 'http://img.51chuanxing.com/Uploads/User/2016/10/18/2016-10-18/5805fd6195bfd.jpg', null, null, null, '1,2');
...
INSERT INTO `cx_auth` VALUES ('1', '129');
INSERT INTO `cx_auth` VALUES ('1', '130');
...
-- ----------------------------
INSERT INTO `cx_discussion` VALUES ('18', '11', '3', null);
INSERT INTO `cx_discussion` VALUES ('17', '11', '3', null);
INSERT INTO `cx_discussion` VALUES ('16', '11', '3', null);
INSERT INTO `cx_discussion` VALUES ('15', '10', '3', null);
INSERT INTO `cx_discussion` VALUES ('14', '9', '3', null);
INSERT INTO `cx_discussion` VALUES ('13', '9', '3', null);
INSERT INTO `cx_discussion` VALUES ('12', '8', '3', null);
INSERT INTO `cx_discussion` VALUES ('11', '8', '3', null);
INSERT INTO `cx_discussion` VALUES ('10', '8', '3', null);
INSERT INTO `cx_discussion` VALUES ('19', '2', '3', null);
...
-- ----------------------------
INSERT INTO `cx_discussion_detail` VALUES ('14', '14', '但是内容非常紧凑', null, '1', '0', '1574776308', null);
INSERT INTO `cx_discussion_detail` VALUES ('13', '13', '这个课好长', null, '1', '0', '1574776293', null);
INSERT INTO `cx_discussion_detail` VALUES ('12', '12', '今天学完了三个课程，感觉自己离满分不远了', null, '1', '0', '1574776263', null);
INSERT INTO `cx_discussion_detail` VALUES ('11', '11', '同学们都很喜欢这道题', null, '1', '0', '1574776247', null);
INSERT INTO `cx_discussion_detail` VALUES ('10', '10', '老师请问这道题怎么做', null, '1', '0', '1574776234', null);
INSERT INTO `cx_discussion_detail` VALUES ('15', '15', '填空题设置的难度太高了，但是动脑引用课中的内容就不觉得那么难了呢', null, '1', '0', '1574776348', null);
INSERT INTO `cx_discussion_detail` VALUES ('16', '16', '沙发', null, '1', '0', '1574776381', null);
INSERT INTO `cx_discussion_detail` VALUES ('17', '17', '板凳', null, '1', '0', '1574776385', null);
INSERT INTO `cx_discussion_detail` VALUES ('18', '18', '地板', null, '1', '0', '1574776389', null);
INSERT INTO `cx_discussion_detail` VALUES ('19', '19', '没点评论看不出啥东西', null, '1', '0', '1575107794', null);
...
-- ----------------------------
INSERT INTO `cx_member` VALUES ('1', '15179811532', 'e10adc3949ba59abbe56e057f20f883e', '大山怪', null, '1573487903', '1573649652', '27.38.247.57', '1', null, null);
INSERT INTO `cx_member` VALUES ('2', '13168770060', 'e10adc3949ba59abbe56e057f20f883e', '啊怪', null, '1573649880', '1573649886', '27.38.247.57', '1', null, null);
INSERT INTO `cx_member` VALUES ('3', '17512020661', 'e10adc3949ba59abbe56e057f20f883e', '大地怪', 'http://hmlwan521.com/Uploads/Home/5dcd7d13cf086.jpg', '1573738475', '1575119697', '27.38.247.23', '1', null, null);
...
CREATE TABLE `cx_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='后台菜单表';
...
INSERT INTO `cx_menu` VALUES ('117', '单词库管理', '116', '1', 'Word', 'index', '', '', '', '0', '3', '1');
...
INSERT INTO `cx_menu` VALUES ('129', '单词类型', '116', '1', 'Word', 'type', '', '', '', '0', '1', '1');
INSERT INTO `cx_menu` VALUES ('130', '单词属性', '116', '1', 'Word', 'category', '', '', '', '0', '2', '1');
...
-- ----------------------------
INSERT INTO `cx_teacher` VALUES ('1', '17512020661', 'e10adc3949ba59abbe56e057f20f883e', '1574776042', '4', '程老师', '1', null, '1', '1', null, null, '/Uploads/Common/2019/11/30/2019-11-30/5de220925f4e7.jpg', 'http://hmlwan521.com/Uploads/Home/5ddbf84e96e6b.png');
INSERT INTO `cx_teacher` VALUES ('2', '13168770060', 'e10adc3949ba59abbe56e057f20f883e', '1575087816', null, '许某人', '1', null, '1', '1', null, null, '/Uploads/Common/2019/11/30/2019-11-30/5de220a2255bc.jpg', 'http://hmlwan521.com/Uploads/Home/5dddd9ed0ca82.png');
INSERT INTO `cx_teacher` VALUES ('3', 'xudaxian', 'e10adc3949ba59abbe56e057f20f883e', null, null, '许大仙', '0', null, null, '1', null, null, '/Uploads/Common/2019/11/22/2019-11-22/5dd6bcdcc7103.jpg', '');
INSERT INTO `cx_teacher` VALUES ('4', 'xianrenzhan', 'e10adc3949ba59abbe56e057f20f883e', '1574534039', null, '仙认账', '0', null, null, '1', null, null, '/Uploads/Common/2019/11/30/2019-11-30/5de220b450c10.jpg', '');
...
-- ----------------------------
INSERT INTO `cx_teacher_correct_task` VALUES ('4', '8', '3', null, '{\"SINGLE_ANSWER\":[],\"QUESTION_ANSWERS\":[],\"FILL_ANSWERS\":[{\"question\":\"this is # wallet # belong #.\",\"answer\":\"archieve#chick#kangroo\",\"stu_answer\":[\"an\",\"must\",\"to\"]},{\"question\":\"this is # still# replay #.\",\"answer\":\"little#change#may\",\"stu_answer\":[\"sand\",\"kick\",\"pan\"]}]}', '0', null, '1574776440');
INSERT INTO `cx_teacher_correct_task` VALUES ('5', '9', '3', null, '{\"SINGLE_ANSWER\":[],\"QUESTION_ANSWERS\":[],\"FILL_ANSWERS\":[{\"question\":\"this is # wallet # belong #.\",\"answer\":\"archieve#chick#kangroo\",\"stu_answer\":[\"io\",\"sod\",\"long\"]},{\"question\":\"this is # still# replay #.\",\"answer\":\"little#change#may\",\"stu_answer\":[\"alioen\",\"union\",\"wick\"]}]}', '0', null, '1574776470');
...
-- ----------------------------
INSERT INTO `cx_teaching_video` VALUES ('1', '大学英语第一节课', '3', '9', '14', '1', '1572678606', '1', null, '/Uploads/Common/2019/11/26/2019-11-26/5ddbfc57c3073.jpg');
INSERT INTO `cx_teaching_video` VALUES ('3', '五年级英语第二节课', '2', '2', '11', '3', '1574698245', '1', '0', '/Uploads/Common/2019/11/26/2019-11-26/5ddbfd020ee00.jpg');
INSERT INTO `cx_teaching_video` VALUES ('2', '五年级英语第一节课', '2', '1', '9', '2', '1573908770', '1', '0', '/Uploads/Common/2019/11/16/2019-11-16/5dcff11c75f45.jpg');
INSERT INTO `cx_teaching_video` VALUES ('4', '五年级英语第三节课', '2', '3', '12', '4', '1574698288', '1', '0', '/Uploads/Common/2019/11/26/2019-11-26/5ddbfd2dde75a.jpg');
INSERT INTO `cx_teaching_video` VALUES ('5', '五年级英语第四节课', '2', '4', '12', '5', '1574698313', '1', '0', '/Uploads/Common/2019/11/26/2019-11-26/5ddbfd46e42e1.jpg');
INSERT INTO `cx_teaching_video` VALUES ('6', '大学英语第二节课', '3', '10', '14', '2', '1574698339', '1', '0', '/Uploads/Common/2019/11/26/2019-11-26/5ddbfd611ec63.jpg');
INSERT INTO `cx_teaching_video` VALUES ('7', '大学英语第三节课', '3', '11', '14', '3', '1574698446', '1', '0', '/Uploads/Common/2019/11/26/2019-11-26/5ddbfdca8586f.jpg');
INSERT INTO `cx_teaching_video` VALUES ('8', '初中英语第一节课', '1', '5', '13', '1', '1574698589', '1', '0', '/Uploads/Common/2019/11/26/2019-11-26/5ddbfe5a1bc69.jpg');
INSERT INTO `cx_teaching_video` VALUES ('9', '初中英语第二节课', '1', '6', '13', '2', '1574698608', '1', '0', '/Uploads/Common/2019/11/26/2019-11-26/5ddbfe6e1be79.jpg');
INSERT INTO `cx_teaching_video` VALUES ('10', '初中英语第三节课', '1', '7', '13', '3', '1574698623', '1', '0', '/Uploads/Common/2019/11/26/2019-11-26/5ddbfe7e228b8.jpg');
INSERT INTO `cx_teaching_video` VALUES ('11', '初中英语第四节课', '1', '8', '13', '4', '1574698651', '1', '0', '/Uploads/Common/2019/11/26/2019-11-26/5ddbfe9aa02cd.jpg');
...
-- Records of cx_video
-- ----------------------------
INSERT INTO `cx_video` VALUES ('1', '五年级第一节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e5%8d%8a%e5%b2%9b%e9%93%81%e7%9b%92.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1571233113', null, '1574697292', null);
INSERT INTO `cx_video` VALUES ('2', '五年级第二节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e7%99%bd%e8%89%b2%e9%a3%8e%e8%bd%a6.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1573908654', null, '1573909062', null);
INSERT INTO `cx_video` VALUES ('3', '五年级第三节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e5%8d%8a%e5%b2%9b%e9%93%81%e7%9b%92.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1574697263', null, '1574697263', null);
INSERT INTO `cx_video` VALUES ('4', '五年级第四节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e5%8d%8a%e5%b2%9b%e9%93%81%e7%9b%92.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1574697278', null, '1574697278', null);
INSERT INTO `cx_video` VALUES ('5', '初中第一节课', 'http://code-products.club/%E8%A7%86%E9%A2%91/%E7%94%B5%E5%BD%B1/%e5%a5%bd%e5%b0%8f%e5%ad%90%e4%bb%ac.mp4', '[00:04.69] 测试测试测试测试测试测试测试测试测试测试测试测试测试\r\n[00:12.09] 测试测试测试测试测试测试测试测试测试测试测试测试测试\r\n[00:15.93] 测试测试测试测试测试测试测试测试测试测试测试测试测试\r\n[00:16.94] 测试测试测试测试测试测试测试测试测试测试测试测试测试\r\n[06:03.80] i don\'t wanne be ......\r\n[06:23.51] 测试测试测试测试测试测试测试测试测试测试测试测试测试\r\n[06:43.38] 测试ldjfklajklfjlafdsf\r\n[17:47.12] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[19:56.49] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[20:41.39] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[20:48.26] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[27:28.42] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[32:41.63] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[35:52.17] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[39:50.56] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[42:51.59] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[44:17.73] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[40:47.75] 测试ooooooooooooooooooooooooooooooooooooooooooooooooooooooo\r\n[46:39.49] 测试kkkkkkkk\r\n[54:44.82] 测试poipiopipokpokq\r\n[01:02:42.41] 测试asdfasfsdfadsfdasfdsf\r\n[01:10:12.77] 测试asdfafdafdfadf\r\n[01:15:15.26] 测试iopupuiouiopuiopuiopipuouiop\r\n[01:21:18.44] 测试iokupiouipouiuipouipojiopasdf\r\n[01:22:31.16] akljfkldjfkl;djklfjk;sdlfjdkl;asjfkl;dsja;fkl;asdjk;flasdfsakljfkldjfkl;djklfjk;sdlfjdkl;asjfkl;dsja;fkl;asdjk;flasdfs\\nakljfkldjfkl;djklfjk;sdlfjdkl;asjfkl;dsja;fkl;asdjk;flasdfsakljfkldjfkl;djklfjk;sdlfjdkl;asjfkl;dsja;fkl;asdjk;flasdfsakljfkldjfkl;djklfjk;sdlfjdkl;asjfkl;dsja;fkl;asdjk;flasdfs\\nakljfkldjfkl;djklfjk;sdlfjdkl;asjfkl;dsja;fkl;asdjk;flasdfsakljfkldjfkl;djklfjk;sdlfjdkl;asjfkl;dsja;fkl;asdjk;flasdfs\\nakljfkldjfkl;djklfjk;sdlfjdkl;asjfkl;dsja;fkl;asdjk;flasdfs\r\n[01:24:54.30] akljfkldjfkl;djklfjk;sdlfjdkl;asjfkl;dsja;fkl;asdjk;flasdfs', '1', '1574697323', null, '1575113468', null);
INSERT INTO `cx_video` VALUES ('6', '初中第二节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e5%8d%8a%e5%b2%9b%e9%93%81%e7%9b%92.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1574697343', null, '1574697343', null);
INSERT INTO `cx_video` VALUES ('7', '初中第三节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e5%8d%8a%e5%b2%9b%e9%93%81%e7%9b%92.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1574697353', null, '1574697353', null);
INSERT INTO `cx_video` VALUES ('8', '初中第四节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e5%8d%8a%e5%b2%9b%e9%93%81%e7%9b%92.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1574697374', null, '1574697374', null);
INSERT INTO `cx_video` VALUES ('9', '大学第一节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e5%8d%8a%e5%b2%9b%e9%93%81%e7%9b%92.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1574697388', null, '1574697388', null);
INSERT INTO `cx_video` VALUES ('10', '大学第二节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e5%8d%8a%e5%b2%9b%e9%93%81%e7%9b%92.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1574697400', null, '1574697407', null);
INSERT INTO `cx_video` VALUES ('11', '大学第三节课', 'http://122.51.187.207/mp3/%e5%91%a8%e6%9d%b0%e4%bc%a6%20-%20%e5%8d%8a%e5%b2%9b%e9%93%81%e7%9b%92.mp3', '\'[00:00.00]寂寞的太空人\\n\' +\r\n        \'[01:13.02]当你回到陆地\\n\' +\r\n        \'[01:17.00]回到平凡而不凡的生活里\\n\' +\r\n        \'[01:23.23]---\\n\' +\r\n        \'[01:25.34]某一刻 或许\\n\' +\r\n        \'[01:27.66]你会在漆黑的夜里 看清\\n\' +\r\n        \'[01:31.56]我曾在那 为你兀自亮起\\n\' +\r\n        \'[01:38.44]---\\n\' +\r\n        \'[01:39.54]而你看见的星\\n\' +\r\n        \'[01:42.67]已是数千年前死亡的\\n\' +\r\n        \'[01:46.87]和你一起的我\\n\' +\r\n        \'[01:50.41]和我一起的你\\n\' +\r\n        \'[01:53.49]和我们曾经明灭的爱情\\n\' +\r\n        \'[01:59.31]---\\n\' +\r\n        \'[01:59.59]曾经那么靠近 你的舞蹈 无重力\\n\' +\r\n        \'[02:07.18]在对谈如絮 彼此牵引的日子里\\n\' +\r\n        \'[02:14.41]只是可惜 我的环境无水 无氧气\\n\' +\r\n        \'[02:22.96]我的重听 以为你说继续原来你说的\\n\' +\r\n        \'[02:30.19]是离去\\n\' +\r\n        \'[02:32.66]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.17]　---\\n\' +\r\n        \'[02:33.22]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.27]　---\\n\' +\r\n        \'[02:33.32]　---\\n\' +\r\n        \'[02:33.37]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:33.42]　---\\n\' +\r\n        \'[02:35.03]旋转的太空人\\n\' +\r\n        \'[02:37.90]当你回到人群\\n\' +\r\n        \'[02:4', '1', '1574697420', null, '1574697420', null);
...
-- ----------------------------
INSERT INTO `cx_video_cate` VALUES ('1', '初中英语', '4', '2', '1', '/Uploads/Common/2019/11/05/2019-11-05/5dc0e4d2cce5e.png', '1', '1574698541');
INSERT INTO `cx_video_cate` VALUES ('2', '五年级英语', '4', '2', '1', '/Uploads/Common/2019/11/16/2019-11-16/5dcfa4e84cd84.jpg', '1', '1575105914');
INSERT INTO `cx_video_cate` VALUES ('3', '大学英语', '6', '2', '1', '/Uploads/Common/2019/11/25/2019-11-25/5ddbfa2b4fdf2.jpg', '1', '1575105919');
...
CREATE TABLE `cx_word` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cate_id` int(11) DEFAULT NULL COMMENT '属性id',
  `word_name` varchar(100) DEFAULT NULL COMMENT '单词名称',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='单词表';

-- ----------------------------
-- Records of cx_word
-- ----------------------------
INSERT INTO `cx_word` VALUES ('1', null, 'demur', '德)德穆尔；(法)德米尔', 'V-I If you demur, you say that you do not agree with something or will not do something that you have been asked to do. 表示异议 [正式]', '&lt;span style=&quot;color:#434343;font-family:Arial, sans-serif;font-size:14px;background-color:#FCFCFE;&quot;&gt;欢迎访问您访问郭威英语网站，本网站内容基于郭威教练新浪博客转载。 ... demonstrate 证明,演示,作示威运动&amp;nbsp;&lt;/span&gt;&lt;span style=&quot;color:#638C0B;font-family:Arial, sans-serif;font-size:14px;background-color:#FCFCFE;&quot;&gt;demur&amp;nbsp;&lt;/span&gt;&lt;span style=&quot;color:#638C0B;font-family:Arial, sans-serif;font-size:14px;background-color:#FCFCFE;&quot;&gt;反对&lt;/span&gt;&lt;span style=&quot;color:#434343;font-family:Arial, sans-serif;font-size:14px;background-color:#FCFCFE;&quot;&gt;,犹豫 denude 剥下,脱去,剥夺 ...&lt;/span&gt;', '异议；反对', '异议；反对', '1', '1572767159', null);
INSERT INTO `cx_word` VALUES ('3', null, null, null, null, null, null, null, '1', '1575641413', '1');

-- ----------------------------
-- Table structure for `cx_word_category`
-- ----------------------------
DROP TABLE IF EXISTS `cx_word_category`;
CREATE TABLE `cx_word_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of cx_word_category
-- ----------------------------

-- ----------------------------
-- Table structure for `cx_word_type`
-- ----------------------------
DROP TABLE IF EXISTS `cx_word_type`;
CREATE TABLE `cx_word_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL COMMENT '名称',
  `op_time` int(11) DEFAULT NULL,
...
-- ----------------------------
-- Records of cx_word_type
-- ----------------------------
INSERT INTO `cx_word_type` VALUES ('1', '同义词', '838', '1');
